			...
			<div class="col-sm-9">
				...
				<div class="container">
					<div class="jumbotron">
						<div class="container">
							<div class="row">
								<div class="col-sm-6" style="height: 20px;">온라인 선불결제</div>
								<div class="col-sm-6" align="right" style="font-size: 2em;">
									8,579원</div>
							</div>
							<div class="row">
								<div class="col-sm-6" style="height: 20px;"></div>
								<div class="col-sm-6" align="right"
									style="font-size: 1em; color: white;">대한민국원</div>
							</div>
							<p>--------------------------------------------------------------------------------------------------------------------------------------------------------------</p>
							<div class="col-sm-6">
								<span class="m-inputBox_label" style="font-size: 2em;"><strong>버즈네스트
										호스텔 홍대</strong></span>
								<p>혼성 도미토리룸 룸 벙커 침대</p>
							</div>
							<div class="row">
								<div class="col-sm-6">
									<span class="m-inputBox_label">2022년 2월 10일</span> <br>
									checkin
								</div>
								<div class="col-sm-6">
									<span class="m-inputBox_label">2022년 2월 11일</span> <br>
									checkout
								</div>
							</div>
							<div>
							...
							<div class="row">
								<div class="col-sm-6">
									<span class="m-inputBox_label">1객실</span> <br>
								</div>
								<div class="col-sm-6">
									<span class="m-inputBox_label">1박</span> <br>
								</div>
							</div>
						</div>
					</div>
				...
				<div style="text-align: center;">
					<button type="submit"
						style="background-color: #FF8000; color: white; width: 700px; margin: 0 auto; text-align: center; font-size: 4em; padding: 2px;">결제하기</button>
				</div>
