...
<!-- Font Awesome Icons -->
<link rel="stylesheet"
	href="../../../plugins/fontawesome-free/css/all.min.css?ver=1">
<link rel="stylesheet"
	href="../../../plugins/fontawesome-free-5.15.4-web/css/all.min.css?ver=1">
<!-- Theme style -->
		...
		<div class="container">
			<div class="jumbotron">
				<div class="container">
					...
					<p>여행을 떠나는 고객에게 최고의 서비스와 추억을 제공할 매니저분들을 모집하고 있습니다. 자세한 사항은 아래에
						링크를 클릭해 주세요♥</p>
					<p>
						<a class="btn btn-primary btn-pull" href="${pageContext.request.contextPath }/app/admin/manager/joinManager.jsp" role="button">자세히
							알아보기</a>
					</p>
				</div>
			</div>
			...
			<div id="carouselExampleIndicators" class="carousel slide"
				...
				<div class="carousel-inner">
					<div class="carousel-item active">
						<img
							src="${pageContext.request.contextPath }/dist/img/seoimg/1.jpg"
							class="d-block w-100" alt="...">
					</div>
					<div class="carousel-item">
						<img
							src="${pageContext.request.contextPath }/dist/img/seoimg/2.jpg"
							class="d-block w-100" alt="...">
					</div>
					<div class="carousel-item">
						<img
							src="${pageContext.request.contextPath }/dist/img/seoimg/3.jpg"
							class="d-block w-100" alt="...">
					</div>
				</div>
