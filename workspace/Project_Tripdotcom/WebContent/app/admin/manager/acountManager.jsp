                                ...
                                <form class="form-horizontal" id="collapseOne" class="collapse" aria-labelledby="multiCollapseExample2" data-parent="#multiCollapseExample2">
                                    <div class="card-body">
                                        <div class="form-group row">
                                            ...
                                            <span class="col-sm-2 control-label">${manager.manager_Issued_Email }</span>
                                        </div>
                                        <div class="form-group row">
                                            <label for=" " class="col-sm-1 control-label">가입일</label>
                                            <span class="col-sm-2 control-label">${manager.manager_joindate }</span>
                                        </div>
                                        <div class="form-group row">
                                            <label for=" " class="col-sm-1 control-label">회사명</label>
                                            <span class="col-sm-2 control-label">123456</span>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <span class="col-sm-8 control-label">123456</span>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>로그인계정</label>
                                    <input class="form-control" type="text" Disabled placeholder="DB에서 불러다가 계정정보 넣기">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
