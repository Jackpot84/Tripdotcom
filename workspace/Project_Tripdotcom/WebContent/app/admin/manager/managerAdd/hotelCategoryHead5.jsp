          ...
          <div class="col-lg-12">
            <nav>
              <div class="nav nav-tabs" id="nav-tab" role="tablist">
                ...
                <a class="nav-link active" id="nav-hotelRule-tab" data-toggle="tab" href="#nav-hotelRule" role="tab" aria-controls="nav-hotelRule" aria-selected="false">호텔 정책</a>
...
<!--                 <a class="nav-link" id="nav-hotelPic-tab" data-toggle="tab" href="#nav-hotelPic" role="tab" aria-controls="nav-hotelPic" aria-selected="false">호텔 사진</a> -->
            ...
            <div class="tab-content" id="nav-tabContent">
              ...
              <div class="tab-pane fade show active" id="nav-hotelRule" role="tabpanel" aria-labelledby="nav-hotelRule-tab">
				<div class="tab_wrapper">		
...
<!-- Main Footer -->
  <footer class="main-footer">
    ...
    <div class="d-none d-sm-inline">
      <div class="row">
      	<div class="col-sm-2">
     		<button type="button" class="btn btn-block btn-primary btn-lg" onclick="Facility()">저장 </button>
   		</div>
    	<div class="col-sm-2">
