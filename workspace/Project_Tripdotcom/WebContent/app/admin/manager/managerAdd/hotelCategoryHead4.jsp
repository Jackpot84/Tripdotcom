          ...
          <div class="col-lg-12">
            <nav>
              <div class="nav nav-tabs" id="nav-tab" role="tablist">
                ...
                <a class="nav-link active" id="nav-roomInfor-tab" data-toggle="tab" href="#nav-roomInfor" role="tab" aria-controls="nav-roomInfor" aria-selected="false">객실 정보</a>
                ...
                <a class="nav-link" id="nav-facilityMgt-tab" data-toggle="tab" href="#nav-facilityMgtr" role="tab" aria-controls="nav-facilityMgt" aria-selected="false">시설 설비</a>
<!--                 <a class="nav-link" id="nav-hotelPic-tab" data-toggle="tab" href="#nav-hotelPic" role="tab" aria-controls="nav-hotelPic" aria-selected="false">호텔 사진</a> -->
              ...
              <div class="tab-pane fade show active" id="nav-roomInfor" role="tabpanel" aria-labelledby="nav-roomInfor-tab">
				<div class="tab_wrapper">		
...
<!-- Main Footer -->
  <footer class="main-footer">
    ...
    <div class="d-none d-sm-inline">
      <div class="row">
      	<div class="col-sm-2">
     		<button type="button" class="btn btn-block btn-primary btn-lg" onclick="hotelRule()">저장 </button>
   		</div>
    	<div class="col-sm-2">
