          ...
          <div class="col-lg-12">
            <nav>
              <div class="nav nav-tabs" id="nav-tab" role="tablist">
                ...
                <a class="nav-link active" id="nav-facilityMgt-tab" data-toggle="tab" href="#nav-facilityMgtrd" role="tab" aria-controls="nav-facilityMgt" aria-selected="false">시설 설비</a>
<!--                 <a class="nav-link" id="nav-hotelPic-tab" data-toggle="tab" href="#nav-hotelPic" role="tab" aria-controls="nav-hotelPic" aria-selected="false">호텔 사진</a> -->
            ...
            <div class="tab-content" id="nav-tabContent">
              ...
              <div class="tab-pane fade show active" id="nav-facilityMgtr" role="tabpanel" aria-labelledby="nav-facilityMgt-tab">
				<div class="tab_wrapper">		
...
<!-- Main Footer -->
  <footer class="main-footer">
    ...
    <div class="d-none d-sm-inline">
      <div class="row">
      	<div class="col-sm-2">
     		<button type="button" class="btn btn-block btn-primary btn-lg" onclick="toSubmit()">저장 </button>
   		</div>
    	<div class="col-sm-2">
