          ...
          <div class="col-lg-12">
            <nav>
              <div class="nav nav-tabs" id="nav-tab" role="tablist">
                <a class="nav-link" id="nav-accomoCate-tab" data-toggle="tab" href="#nav-accomoCate" role="tab" aria-controls="nav-accomoCate" aria-selected="false">숙박 시설 분류 </a>
                <a class="nav-link active" id="nav-hotelInfor-tab" data-toggle="tab" href="#nav-hotelInfor" role="tab" aria-controls="nav-hotelInfor" aria-selected="true">호텔 정보</a>
                ...
                <a class="nav-link" id="nav-facilityMgt-tab" data-toggle="tab" href="#nav-facilityMgtrs" role="tab" aria-controls="nav-facilityMgt" aria-selected="false">시설 설비</a>
            ...
            <div class="tab-content" id="nav-tabContent">
        	 <div class="tab-pane fade" id="nav-accomoCate" role="tabpanel" aria-labelledby="nav-accomoCate-tab">
				<div class="tab_wrapper">		
					<%@ include file="accommodationCategory.jsp" %>
				</div>
			  </div>
              <div class="tab-pane fade show active" id="nav-hotelInfor" role="tabpanel" aria-labelledby="nav-hotelInfor-tab">
				<div class="tab_wrapper">		
...
<!-- Main Footer -->
  <footer class="main-footer">
    ...
    <div class="d-none d-sm-inline">
      <div class="row">
      	<div class="col-sm-2">
     		<button type="button" class="btn btn-block btn-primary btn-lg" onclick="hotelinfo()">저장 </button>
   		</div>
    	<div class="col-sm-2">
